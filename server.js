...
const Barber = mongoose.model('Barber', new mongoose.Schema({
    ...
    username: { type: String, required: false }, // Para el login
    password: { type: String, required: false }  // Para el login
}));
...
// Corrección aplicada aquí para mapear adecuadamente los datos de la reserva
